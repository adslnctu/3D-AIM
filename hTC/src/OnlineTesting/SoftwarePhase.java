...
public class SoftwarePhase {
	...
	public void testing(String fileName, Profile profile, int fileNo, long elapsedTime) throws Exception {
		...
		{
			int a = fileName.indexOf(" ", 0);
			
			String dateString = fileName.substring(a-10,a+9);
	        ...
	        long milliseconds = parsedDate.getTime()/1000;
	        ...
	        String fileName2 = fileName.substring(0,a-10)+dateText+fileName.substring(a+9,fileName.length());
